...
fetch(fiveapiURL)
  ...
  const imagesrcDayOne = 'https://openweathermap.org/img/wn/' + jsObjecttwo.list[5].weather[0].icon + '@2x.png';  // note the concatenation
  ...
  const imagesrcDayTwo = 'https://openweathermap.org/img/wn/' + jsObjecttwo.list[13].weather[0].icon + '@2x.png';  // note the concatenation
  ...
  const imagesrcDayThree = 'https://openweathermap.org/img/wn/' + jsObjecttwo.list[21].weather[0].icon + '@2x.png';  // note the concatenation
  ...
  const imagesrcDayFour = 'https://openweathermap.org/img/wn/' + jsObjecttwo.list[29].weather[0].icon + '@2x.png';  // note the concatenation
  ...
  const imagesrcDayFive = 'https://openweathermap.org/img/wn/' + jsObjecttwo.list[37].weather[0].icon + '@2x.png';  // note the concatenation
